...
const greetings = ['AJunj', 'MAN', '哇塞明', 'Warriorsº', ' ALwj', '12月25','puff', '谢发财', 'Merry Christmas','谢发财', 'MAN', '图图小霸王',
    'AJunj', 'MAN', '哇塞明','puff', 'Warriorsº', ' ALwj', '谢发财', '斯蒂芬', 'Merry Christmas','谢发财', 'MAN', '图图小霸王','puff',
    'MAN', '图图小霸王','谢发财',
];
